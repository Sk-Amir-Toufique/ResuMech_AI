...
const TemplateSelecetor = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        {
            id: "classic",
            name: "Classic",
            preview: "A clean and traditional resume format with clear sections and clear typography."
        },
        {
            id: "modern",
            name: "Modern",
...
export default TemplateSelecetor
